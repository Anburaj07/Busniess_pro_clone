...
const Mission = () => {
  ...
  return (
    <div className="w-[82%] m-auto mt-8 flex justify-between">
      {/* Left Content */}
      <div className="w-[48.5%] flex flex-col gap-4 text-[#505050] leading-relaxed">
        ...
        <p>
          ...
          clients, and believe that building strong relationships is the key to
          our success. Moreover, we believe in building websites that are
          sustainable and scalable, ensuring that our clients are able to
      ...
      <div className="w-[49%] text-center">
        <div className="relative w-[92%] h-[340px] m-auto cursor-pointer">
          <YouTube
            videoId={videoId}
            opts={{
              height: "340",
